...
interface VictoryMessageProps {
    ...
    setIsVictoryOpen: (isEndGameOpen: boolean) => void;
    game: Game;
}

export default function VictoryMessage({ isVictoryOpen, setIsVictoryOpen, game }: VictoryMessageProps ) {
    ...
    return (
        <Dialog open={isVictoryOpen} onOpenChange={() => {}}>
            <DialogContent
            ...
            >
                <DialogHeader>
                    <DialogTitle className="text-3xl text-center text-green-500 animate-pulse">
                        Victoire ! 🎉
                    </DialogTitle>
                ...
                <div className="flex flex-col items-center gap-4 my-6">
                    <p className="text-sm text-muted-foreground">Code secret :</p>
                ...
                <DialogFooter className="flex justify-center sm:justify-center">
                    <Button
                        ...
                        className="bg-green-600 hover:bg-green-700 text-white px-8 active:scale-95 transition-transform"
                    >
                        Terminer
                    </Button>
                </DialogFooter>
